    ...
    const calculate = (nums, ops) => {
      ...
      for (let i = 0; i < ops.length; i++) {
        if (ops[i] === "+") {
          ...
          result = parseInt("" + result + nums[i + 1], 10);
        }
      }
      return result;
    };
    ...
    <div className="part-container">
      ...
      <div className="problem-container">
        <div className="problem-description-container">
          ...
          <br /><br />
          156: 15 6 can be made true through a single concatenation: 15 || 6 = 156.<br />
          7290: 6 8 6 15 can be made true using 6 * 8 || 6 * 15.<br />
          192: 17 8 14 can be made true using 17 || 8 + 14.<br /><br />
