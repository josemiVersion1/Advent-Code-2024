...
const Part1 = () => {
  ...
  const calculateDistance = () => {
    ...
    const totalDistance = leftList.reduce((sum, leftValue, index) => {
      const distance = Math.abs(leftValue - rightList[index])
      return sum + distance
    }, 0)
      ...
      <div className="problem-container">
        <div className="problem-description-container">
          ...
          <p>The Chief Historian is always present for the big Christmas sleigh launch, but nobody has seen him in months! Last anyone heard, he was visiting locations that are historically significant to the North Pole; a group of Senior Historians has asked you to accompany them as they check the places they think he was most likely to visit.
            ...
            The fifth-smallest numbers in each list are 3 and 5, a distance of 2.<br /><br />
        ...
        <div className="problem-input-container">
          ...
          />
          <button className='submit-button' onClick={calculateDistance}>
            Calculate Distance
          </button>
        </div>
      </div>
